...
def count_words(words):
    return len(words)  # Added 'return' statement
...
print_first_word(words.copy())  # Used words.copy() to avoid modifying the original list
print_last_word(words.copy())   # Used words.copy() to avoid modifying the original list
