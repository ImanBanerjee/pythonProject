...
# functions scope is the block of code where the function is defined
# code inside of a function runs differently than code outside of a function
...
# functions should be defined at the top of the code
# functions can be called anywhere in the code
# functions can be called multiple times
# functions should be in same tab as the code
